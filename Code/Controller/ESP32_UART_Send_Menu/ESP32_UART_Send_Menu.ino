#define TXD_PIN 17  // UART2 TX
#define RXD_PIN 16  // UART2 RX
...
void setup() {
  ...
  // Initialize UART2 on specified pins with 9600 baud, 8 data bits, no parity, 1 stop bit
...
void loop() {
  if (stringComplete) {
    ...
    // Ensure that an even number of hex digits is provided
      ...
      // Send the byte array over UART2
      Serial2.write(byteArray, numBytes);
