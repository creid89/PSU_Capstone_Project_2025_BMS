...
volatile bool BATTERYDETECTED = false;
float MAX_CELL_VOLTAGE = 3.7;
...
void Balance_Cells(){
  ...
  if(CELL1_VOLTAGE >= MAX_CELL_VOLTAGE)
  {
  ...
  if(CELL2_VOLTAGE >= MAX_CELL_VOLTAGE)
  {
  ...
  if(CELL3_VOLTAGE >= MAX_CELL_VOLTAGE)
  {
  ...
  if(CELL4_VOLTAGE >= MAX_CELL_VOLTAGE)
  {
